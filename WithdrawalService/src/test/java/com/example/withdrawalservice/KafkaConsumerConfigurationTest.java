package com.example.withdrawalservice;
...
class KafkaConsumerConfigurationTest {
    ...
    void consumerFactory_usesConfiguredKafkaConsumerProperties() {
        ...
        assertEquals("withdrawal-group", properties.get(ConsumerConfig.GROUP_ID_CONFIG));
    ...
    private KafkaConsumerConfiguration configWithEnvironment() {
        ...
        when(environment.getProperty("spring.kafka.consumer.group-id")).thenReturn("withdrawal-group");
